...
/** ArraySortUtil contains all of the useful sorts that I have written for myself
 *  that work only on Arrays. This is a copy of the Arrays project SortUtil.
...
public class ArraySortUtil {
	...
	public static void main(String args[]) {
		...
		System.out.println(ArraySortUtil.insertionSort(chars));
		
		Integer[] ints = { 1, 3, 5, 2, 4 };
		ArraySortUtil.insertionSort(ints);
